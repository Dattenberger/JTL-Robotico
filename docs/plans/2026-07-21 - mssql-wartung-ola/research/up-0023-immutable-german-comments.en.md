...
6. **Plan `mssql-wartung-ola.md` D35 (line 362)** — the plan authors already state "`up/0023` is
   immutable after apply" as a design premise (they even pulled the `hourly` schedule decision
...
- Plan `mssql-wartung-ola.md` D35 (L362) — "up/0023 is immutable after apply"
