...
-- developer login (LoginName, read from ops.Mandant by @MandantKey — uniform step
...
BEGIN
    ...
    SELECT @LoginName = LoginName FROM ops.Mandant WHERE MandantKey = @MandantKey;
    ...
    EXEC reset.internal_LogStep @RequestId, @note;
END
GO
