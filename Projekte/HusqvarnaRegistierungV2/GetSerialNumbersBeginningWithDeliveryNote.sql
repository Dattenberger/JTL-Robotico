...
DECLARE @lastDeliveryNodeID INT = 160555;
...
SELECT
       tL.kLieferschein as deliveryNodeID,
       tLA.kLagerArtikel as serialNumberID,
       tL.cLieferscheinNr as deliveryNoteNumber,
       tLA.cSeriennr as serialNumber,
        cast(replace(convert(char(8), tL.dErstellt, 104), '.', '') as int) as deliveryNodeDate,
       tB.cBestellNr as oderNumber,
       tBP.cString as article,
       tA.cHAN as arcticlePNC,
       tB.tKunde_kKunde as customerID,
       tB.kBestellung as orderID,
